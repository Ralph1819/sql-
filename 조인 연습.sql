...
select a.emp_no as '사번' , concat(a.first_name,' ',a.last_name) as '이름', c.title as '직책'
...
select a.emp_no as '사번' , concat(a.first_name,' ',a.last_name) as '이름', b.salary as '연봉', c.title as '직책', 
e.dept_name as '부서'
